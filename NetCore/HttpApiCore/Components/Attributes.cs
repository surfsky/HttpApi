...
namespace App.HttpApi
{
    ...
    internal class TAttribute : Attribute
    {
        ...
        public string GetText()
        {
            ...
            var manager = new System.Resources.ResourceManager("AppPlat.HttpApi.Properties.Resources", this.GetType().Assembly);
    ...
    public class HttpApiAttribute : Attribute
    {
        ...
        public ResponseCacheLocation CacheLocation { get; set; } = ResponseCacheLocation.Any;
        ...
        public HttpApiAttribute(string group, string description, bool authLogin = false, int cacheSeconds = 0)
        {
            this.Group = group;
            this.Description = description;
            this.AuthLogin = authLogin;
